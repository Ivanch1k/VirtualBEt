...
$client = pq_query($mysql,"SELECT * FROM client WHERE Mail = '$email';");
$emailCounter = 0;
foreach ($client as $c){
    $emailCounter++;
}
...
if($emailCounter > 0){
    ...
    if ($number != "+380") {
        $result = pq_query($mysql,"INSERT INTO client(Name, SecondName, DateOfBirth, Mail, PhoneNumber, Pass, Balance) VALUES('$name','$secondName','$date','$email','$number','$pass',300);");
    } else {
